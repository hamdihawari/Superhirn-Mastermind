...
upperCenter_frame = tk.Frame(root, bg="green", borderwidth=5, padx=10, pady=2)
...
center_frame = tk.Frame(root, bg="green", borderwidth=5, padx=10, pady=2)
...
lower_frame = tk.Frame(root, bg="green", borderwidth=5, padx=10, pady=2)
